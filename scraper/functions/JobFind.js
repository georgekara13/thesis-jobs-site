...
module.exports =
{
  ...
  {
    let fetched_urls = await driver.findElements(webdriver.By.xpath("/html/body/form/div[4]/div/div[2]/div[1]/div/div[1]/div/div[1]/h3/a"))
  ...
  ad_page: async function(driver,ad_url,ad_fields)
  {
    ...
    await driver.findElement(webdriver.By.xpath("/html/body/form/div[4]/div/div[2]/div[2]/div/div/h1")).getText()
    ...
    await driver.findElement(webdriver.By.id("jobadview")).getText()
